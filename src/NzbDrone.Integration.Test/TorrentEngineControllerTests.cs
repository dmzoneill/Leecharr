...
public class TorrentEngineControllerTests : IntegrationTestBase
{
    ...
    {
        var response = await Client.GetAsync("/api/v1/torrentengine");
    ...
    {
        var response = await Client.GetAsync("/api/v1/torrentengine/active");
        response.StatusCode.Should().Be(HttpStatusCode.OK);
    ...
    {
        var response = await Client.PostAsync("/api/v1/torrentengine/MonoTorrent/probe", null);
        response.StatusCode.Should().Be(HttpStatusCode.OK);
    ...
    public async Task SwitchEngine_to_LibTorrent_and_back_to_MonoTorrent()
    {
        ...
        var response1 = await PostJsonAsync("/api/v1/torrentengine/switch", switchReq1);
        ...
        var activeResponse1 = await Client.GetAsync("/api/v1/torrentengine/active");
        ...
        var response2 = await PostJsonAsync("/api/v1/torrentengine/switch", switchReq2);
