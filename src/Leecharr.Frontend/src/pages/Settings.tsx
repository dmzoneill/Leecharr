...
const sectionDescriptions: Record<string, string> = {
  general:
    "Configure application host parameters, ports, and watch folder automation",
  webui:
    "Configure web user interface access, authentication modes, and sessions",
  notifications:
    "Configure webhooks and alerts for download grab, completion, and seed goals",
  seeding:
    "Manage categories, incomplete storage paths, target ratios, and auto-stop rules",
  bittorrent:
    "Configure MonoTorrent engine, rarest-first picker, write cache, and encryption",
  network:
    "Network interface binding (tun0/wg0), VPN Kill Switch, and proxy settings",
  "peer-protocol":
    "Peer handshake timeouts, keepalive intervals, and swarm behavior",
  protocols:
    "BEP extensions, transport layers (TCP/uTP), DHT, and PEX peer exchange",
  ...
  "download-clients":
    "Simultaneous qBittorrent WebAPI, Deluge JSON-RPC, and Transmission RPC adapters",
