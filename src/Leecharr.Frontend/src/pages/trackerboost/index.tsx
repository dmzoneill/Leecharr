    ...
    >
      ...
      >
        <div>
          ...
          >
            <span>🚀</span> {t("trackerBoost.title", "Tracker Boost")}
            <span
      ...
      >
        <div className="stat-card">
          ...
          <div className="stat-label">
            {t("trackerBoost.trackersMonitored", "Trackers Monitored")}
          </div>
        </div>
        <div className="stat-card">
        ...
        <div className="stat-card">
          ...
          <div className="stat-label">
            {t("trackerBoost.harvestedFromSwarms", "Harvested from Swarms")}
          </div>
        </div>
        <div className="stat-card">
          ...
          <div className="stat-label">
            {t("trackerBoost.swarmsBoosted", "Swarms Boosted")}
          </div>
        </div>
      </div>
