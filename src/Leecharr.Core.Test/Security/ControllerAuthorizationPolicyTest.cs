...
public class ControllerAuthorizationPolicyTest
{
    ...
    [TestCase(typeof(ArrSyncController), "RequireOperator")]
    [TestCase(typeof(DownloadClientSyncController), "RequireOperator")]
    [TestCase(typeof(RssRuleController), "RequireOperator")]
    [TestCase(typeof(TorrentEngineController), "RequireOperator")]
    [TestCase(typeof(SeedingController), "RequireOperator")]
    [TestCase(typeof(SpeedScheduleController), "RequireOperator")]
    [TestCase(typeof(TagController), "RequireOperator")]
    [TestCase(typeof(TrackerBoostController), "RequireOperator")]
