...
public class TorrentServiceTest
{
    ...
    [Test]
    public async Task AddFromParsedTorrentAsync_WhenTorrentWithUppercaseInfoHashAlreadyExists_ReturnsExistingTorrent()
    {
        var existingTorrent = new Torrent
        {
            Id = 99,
        ...
        var parsed = new ParsedTorrent
        {
            Name = "Duplicate Uppercase Torrent",
            InfoHash = "1234567890ABCDEF1234567890ABCDEF12345678",
            PieceLength = 1024,
            TotalSize = 2048,
            Files = new List<ParsedTorrentFile> { new() { Path = "f.mkv", Size = 2048 } },
    ...
    public async Task MoveQueueBatchAsync_MoveUp_AtTopBoundary_LocksBoundaryAndPreventsLeapfrogging()
    {
        ...
        await this.service.MoveQueueBatchAsync(new[] { 1, 2 }, "up");

        this.torrentRepository.Received(1).UpdateMany(Arg.Is<IEnumerable<Torrent>>(torrents =>
            torrents != null &&
            torrents.Count() == 3 &&
            torrents.ElementAt(0).Id == 1 && torrents.ElementAt(0).QueuePosition == 1 &&
            torrents.ElementAt(1).Id == 2 && torrents.ElementAt(1).QueuePosition == 2 &&
            torrents.ElementAt(2).Id == 3 && torrents.ElementAt(2).QueuePosition == 3));
    }

    [Test]
    public async Task MoveQueueBatchAsync_MoveUp_NonBoundary_MovesTogetherPreservingOrder()
    {
        var t1 = new Torrent { Id = 1, Name = "T1", QueuePosition = 1 };
        var t2 = new Torrent { Id = 2, Name = "T2", QueuePosition = 2 };
        var t3 = new Torrent { Id = 3, Name = "T3", QueuePosition = 3 };
        ...
        await this.service.MoveQueueBatchAsync(new[] { 2, 3 }, "up");
    ...
    [Test]
    public async Task MoveQueueBatchAsync_MoveDown_AtBottomBoundary_LocksBoundaryAndPreventsLeapfrogging()
    {
        var t1 = new Torrent { Id = 1, Name = "T1", QueuePosition = 1 };
        var t2 = new Torrent { Id = 2, Name = "T2", QueuePosition = 2 };
        var t3 = new Torrent { Id = 3, Name = "T3", QueuePosition = 3 };
        ...
        await this.service.MoveQueueBatchAsync(new[] { 2, 3 }, "down");
    ...
    [Test]
    public async Task MoveQueueBatchAsync_MoveDown_NonBoundary_MovesTogetherPreservingOrder()
    {
        var t1 = new Torrent { Id = 1, Name = "T1", QueuePosition = 1 };
        var t2 = new Torrent { Id = 2, Name = "T2", QueuePosition = 2 };
        var t3 = new Torrent { Id = 3, Name = "T3", QueuePosition = 3 };
        ...
        this.torrentRepository.Received(1).UpdateMany(Arg.Is<IEnumerable<Torrent>>(torrents =>
            ...
            torrents.Count() == 4 &&
            torrents.ElementAt(0).Id == 1 && torrents.ElementAt(0).QueuePosition == 1 &&
            torrents.ElementAt(1).Id == 4 && torrents.ElementAt(1).QueuePosition == 2 &&
            torrents.ElementAt(2).Id == 2 && torrents.ElementAt(2).QueuePosition == 3 &&
            torrents.ElementAt(3).Id == 3 && torrents.ElementAt(3).QueuePosition == 4));
    }

    [Test]
    public async Task MoveQueueBatchAsync_MoveUp_WithOutOfOrderIds_ProcessesInAscendingQueueOrder()
    {
        var t1 = new Torrent { Id = 1, Name = "T1", QueuePosition = 1 };
        var t2 = new Torrent { Id = 2, Name = "T2", QueuePosition = 2 };
        var t3 = new Torrent { Id = 3, Name = "T3", QueuePosition = 3 };
        ...
        // Pass out of order: 3 then 2
        await this.service.MoveQueueBatchAsync(new[] { 3, 2 }, "up");
